<template>
	<view class="content">
		<view class="inner flexbox flex_alignc" style="height: 44upx;" :class="[fixed ? 'fixed' : '']" :style="[{'height': customBarH + 'px', 'padding-top': statusBarH + 'px', 'color': titleTintColor}, bgColor]">
			<!-- 返回 -->
			...
			<!-- #endif -->
			<view class="uni_title flex1" :class="[center ? 'uni_titleCenter' : '']" :style="[isBack ? {'font-size': '32upx', 'padding-left': '0'} : '']"
			 v-if="!search && title">
				{{title}}
			</view>
